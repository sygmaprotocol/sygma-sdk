 ...
 */
export const createProposalExecutionEventListener = (homeDepositNonce, bridge, callbackFn) => {
 ...
 */
export const proposalExecutionEventListenerCount = (bridge) => {
    const proposalFilter = bridge.filters.ProposalExecution(null, null, null);
 ...
 */
export const removeProposalExecutionEventListener = (bridge) => {
    const proposalFilter = bridge.filters.ProposalExecution(null, null, null);
 ...
 * @returns {Bridge} - The Bridge contract instance with the event listener attached.
 */
export const createDepositEventListener = (bridge, userAddress, callbackFn) => {
 ...
 */
export const removeDepositEventListener = (bridge) => {
