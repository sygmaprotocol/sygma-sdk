...
import type { Fungible, Transfer } from '../../../types/index.js';
/**
 ...
 */
export declare const getPercentageFee: (api: ApiPromise, transfer: Transfer<Fungible>) => Promise<SubstrateFee>;
//# sourceMappingURL=getPercentageFee.d.ts.map