 ...
 */
export declare const isApproved: (tokenId: number, tokenInstance: ERC721MinterBurnerPauser, handlerAddress: string) => Promise<boolean>;
/**
 ...
 */
export declare const getERC20Allowance: (senderAddress: string, erc20Instance: ERC20, erc20HandlerAddress: string) => Promise<BigNumber>;
/**
 ...
 */
export declare const approve: (amountOrIdForApproval: string, tokenInstance: ERC20 | ERC721MinterBurnerPauser, handlerAddress: string) => Promise<PopulatedTransaction>;
//# sourceMappingURL=approvesAndChecksFns.d.ts.map