    ...
    domains: [
        {
            ...
            chainId: 1337,
            name: 'Ethereum 1',
            type: index_js_1.Network.EVM,
            bridge: '0x6CdE2Cd82a4F8B74693Ff5e194c19CA08c2d1c68',
            handlers: [
                {
                    type: index_js_1.ResourceType.FUNGIBLE,
                    address: '0x02091EefF969b33A5CE8A729DaE325879bf76f90',
                },
                {
                    type: index_js_1.ResourceType.NON_FUNGIBLE,
                    address: '0xC2D334e2f27A9dB2Ed8C4561De86C1A00EBf6760',
                },
                {
                    type: index_js_1.ResourceType.PERMISSIONLESS_GENERIC,
                    address: '0xE837D42dd3c685839a418886f418769BDD23546b',
                },
                {
                    type: index_js_1.ResourceType.PERMISSIONED_GENERIC,
            ...
            feeHandlers: [
                ...
                },
                {
                    ...
                    type: index_js_1.FeeHandlerType.DYNAMIC,
                },
            ],
            resources: [
                {
        ...
        },
        {
            ...
            chainId: 5,
            name: 'Substrate',
            type: index_js_1.Network.SUBSTRATE,
