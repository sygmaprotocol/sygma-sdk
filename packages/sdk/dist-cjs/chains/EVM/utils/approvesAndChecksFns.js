...
exports.approve = exports.getERC20Allowance = exports.isApproved = void 0;
/**
 ...
 */
const isApproved = async (tokenId, tokenInstance, handlerAddress) => {
 ...
 */
const getERC20Allowance = async (senderAddress, erc20Instance, erc20HandlerAddress) => {
 ...
 */
const approve = async (amountOrIdForApproval, tokenInstance, handlerAddress) => {
