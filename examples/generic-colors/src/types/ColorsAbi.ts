...
export interface ColorsAbiInterface extends utils.Interface {
  contractName: "ColorsAbi";
  functions: {
...
export interface ColorsAbi extends BaseContract {
  contractName: "ColorsAbi";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ColorsAbiInterface;
